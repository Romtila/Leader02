        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequirementNpasJson = table.Column<string>(type: "text", nullable: true),
                    RequirementProfilingJson = table.Column<string>(type: "text", nullable: true),
                    RequirementVerificationMethodsJson = table.Column<string>(type: "text", nullable: true),
                    RequirementResponsibilitiesJson = table.Column<string>(type: "text", nullable: true),
                    DepartmentId = table.Column<int>(type: "integer", nullable: true),
                    SubDepartmentId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
